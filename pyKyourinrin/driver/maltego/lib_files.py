...
class MaltegoEntity:
    ...
    def new_entity_info_from_primitive(self, name, icon):
        ...
        maltego_entity = ET.Element('MaltegoEntity', id='pykyourinrin.{}'.format(name), displayName=name,
        ...
        with open(self.directory_save_file + 'pykyourinrin/pykyourinrin.{}.entity'.format(name), 'x') as f:
    ...
    def save_layer(self):
        ...
        ET.SubElement(folder_first_personal, 'file', name='pykyourinrin.Unknown.entity', url='pykyourinrin.Unknown.entity')
        ...
        for i in self.list_entity:
            ET.SubElement(folder_second_personal, 'file', name='pykyourinrin.{}.entity'.format(i), url='pykyourinrin/pykyourinrin.{}.entity'.format(i))
...
class MaltegoTransform:
    ...
    def new_transform(self, name, entity_exclusive, parameter):
        for i in entity_exclusive: # gambiarra por conta do constraint ser um "e lógico", e não "ou lógico", e há crawlers que podem ser executador tanto por uma como por outra primitive
            # MaltegoTransform
            maltego_transform = ET.Element('MaltegoTransform', name='pykyourinrin.{}_{}'.format(name, i), displayName=name, abstract='false',
            ...
            ET.SubElement(input_constraints, 'Entity', type='pykyourinrin.{}'.format(i))

            with open(self.directory_save_file + '/local/pykyourinrin.{}_{}.transform'.format(name, i), 'x') as f:
            ...
            with open(self.directory_save_file + '/local/pykyourinrin.{}_{}.transformsettings'.format(name, i), 'x') as f:
    ...
    def save_layer(self):
        ...
        for i in self.list_transform:
            ET.SubElement(folder_second, 'file', name='pykyourinrin.{}.transform'.format(i), url='local/pykyourinrin.{}.transform'.format(i))
            ET.SubElement(folder_second, 'file', name='pykyourinrin.{}.transformsettings'.format(i), url='local/pykyourinrin.{}.transformsettings'.format(i))
